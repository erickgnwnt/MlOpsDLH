...
class BaseModel:
    ...
    def evaluate(self, X_train, X_test, y_train, y_test):
        ...
        try:
            ...
            # ✅ Handle Multiclass Precision-Recall & ROC AUC
            ...
            # Handle feature importance for RandomForest
...
class LogisticModel(BaseModel):
    def __init__(self, num_classes=3):  # Adjust `num_classes` as needed
        super().__init__(LogisticRegression(solver="lbfgs", max_iter=1000, random_state=42), "Logistic Regression", num_classes)
...
class RandomForestModel(BaseModel):
    def __init__(self, n_estimators=100, max_depth=None, num_classes=3):
        super().__init__(RandomForestClassifier(n_estimators=n_estimators, max_depth=max_depth, random_state=42), "Random Forest", num_classes)

class KNNModel(BaseModel):
    def __init__(self, n_neighbors=5, weights="uniform", num_classes=3):
        super().__init__(KNeighborsClassifier(n_neighbors=n_neighbors, weights=weights), "KNN", num_classes)